...
|------|---------|----------------|
| `.github/planning-with-files/session/${date}/task_plan.md` | Phases, progress, decisions | After each phase |
| `.github/planning-with-files/session/${date}/findings.md` | Research, discoveries | After ANY discovery |
| `.github/planning-with-files/session/${date}/progress.md` | Session log, test results | Throughout session |
